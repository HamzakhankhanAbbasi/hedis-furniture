...
<div class="inner-pg-wrap inner-page-main">
<style>
...
/*PAYMENT FORM*/
.payment-card .form-container .field-container:first-of-type {
  grid-area: name;
}
.payment-card .form-container .field-container:nth-of-type(2) {
  grid-area: number;
}
.payment-card .form-container .field-container:nth-of-type(3) {
  grid-area: expiration;
}
.payment-card .form-container .field-container:nth-of-type(4) {
  grid-area: security;
}
.payment-card .form-container .field-container:nth-of-type(5) {
  grid-area: submit;
}
...
.payment-card .form-container {
  ...
  grid-template-areas: "name name""number number""expiration security" "submit submit";
  max-width: 100%;
  padding: 20px 0;
  color: #707070;
}
...
.order-summary-card .summary-group ul:before {
    top: 42px;
    width: calc(100% - 0px);
    height: 1px;
}
...
/*****CHECKOUT PAGE START END'S*****/
</style>
	<section class="checkout-sec-2">
	    <div class="categories-head">
    		<h5>Check Out</h5>
    		<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed vonumistrate lerat</p>
	    </div>
		<div class="container">
			<div class="row">
						...
						<div class="tab-content">
							...
							<form class="payment-form">
								<div class="form-container">
									<div class="field-container payment-input-col">
										<input id="name" maxlength="20" type="text" placeholder="Name">
									</div>
									<div class="field-container payment-input-col">
									...
									<div class="field-container payment-input-col">
										<input id="expirationdate" type="text" pattern="[0-9]*" inputmode="numeric" placeholder="Expiration (mm/yy)">
									</div>
									<div class="field-container payment-input-col">
						...
						<div class="checkout-form">
							...
							<div class="cart-list-item">
								<div class="product-img">
									<img src="assets/images/product-03-1.jpg" class="img-fluid" alt="phone case">
								</div>
								<div class="product-name">
									<p class="name">Grandpa's Star</p>
							...
							<div class="cart-list-item">
								<div class="product-img">
									<img src="assets/images/product-06-1.jpg" class="img-fluid" alt="phone case">
								</div>
								<div class="product-name">
									<p class="name">Dad's MVP' Baseball</p>
									<p class="price">$5.00</p>
								</div>
								<div class="product-action-price y-center">
									<p>$5.00</p>
				...
				<div class="summary-group">
					...
					<!--<div class="summry-button">-->
					<!--    <a href="#!" class="banner-btn mt-4">Place Order</a>-->
					<!--</div>-->
				</div>
			</div>
							<div class="order-submit-btn">
							    <button type="submit" class="submit" data-toggle="modal" data-target="#order-confirmModal">Submit</button>
							</div>
						</div>
					</div>
				</div>
